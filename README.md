...
1. What is the DOM?
    ...
    - The DOM (Document Object Model) is an Object-Like tree structure that allows the HTML structure or document to be 
      accessed and updated dynamically.

2. What is an event?
    
    - An event is an occurance to the DOM. Example: user clicking a button or scrolling.

3. What is an event listener?

    - Event listener is a function that waits on an element on the DOM for an event, so as to
      perform a specific task. 

4. Why would we convert a NodeList into an Array?

    - We convert NodeList to an Array to have access to all Array Methods. Example: map, filter, reduce...

5. What is a component?

    - A Component is a reusable piece of code that is used to build custom HTML elements having the same styling
      and functionality.
